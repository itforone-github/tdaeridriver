...
public class MainActivity extends AppCompatActivity {
    ...
    public void webViewSetting() {
        ...
        setting.setUserAgentString("Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Mobile Safari/537.36"+"/Driver");
    ...
    Handler mHandler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(LocationPosition.lng!=0.0){
                ...
                webView.loadUrl(getString(R.string.url)+"&currentLat=" + LocationPosition.lat + "&currentLng=" + LocationPosition.lng);
            }else{
                if(gpsCount==0)
